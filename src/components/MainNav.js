  ...
  render() {
    return (
      <nav className="uc-main-nav">
        <Link to="/"><img className="uc-main-nav__logo" type="image/png" src="/img/uc_logo_sm.png"/></Link>
        ...
        <img className="uc-main-nav__secondary-logo" type="image/png" src="/img/lh_logo_sm.png"/>
      </nav>
    )
  }
}
